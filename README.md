...
1. 双击运行 `Nebula-Setup.exe`
2. 按向导选择安装目录(默认 `C:\Users\用户名\AppData\Local\Programs\Nebula`)
3. 安装完成后**桌面自动出现「Nebula」快捷方式**,双击即可打开
...
- 动效:缓动曲线,封面旋转、图标过渡、视图切换;系统开启"减弱动效"时自动禁用
